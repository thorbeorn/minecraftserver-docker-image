<?php 
    ...
    if(!empty($_POST['email']))
    {
        ...
        $check = $pdo->prepare('SELECT pseudo, email, password FROM _user WHERE email = ?');
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="http://your-website.com/reset_password.php?key='. $reset_key .'" class="btn btn-primary btn-block">Réinitialiser le mot de passe</a>
